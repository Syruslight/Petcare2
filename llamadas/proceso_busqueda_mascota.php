...
if ($result->num_rows > 0) {
  ...
  while ($row = $result->fetch_assoc()) {
    $output .= '<tr>
              ...
              <a href="" class="butModal btn btn-sm" data-modal=".modalMascotaCarne" data-nombre2="' .$row['nombre'] .'" data-fotoperfil2="' .$row['fotoPerfil'] .'" style="background-color:#1D3534; color:#1BC5BD;">Ver Carnet</a>
              </td>
          </tr>';
  }
