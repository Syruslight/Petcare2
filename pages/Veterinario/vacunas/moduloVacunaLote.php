...
<body>
    ...
    <?php
      ...
      <div class="contForm">
        <aside class="formVacuna">
          ...
          <form action="../../../llamadas/proceso_registrarDetalleVacuna.php" method="post" enctype="multipart/form-data">
  ...
  <label for="" class="etiqueta_nombre"> Lote de Vacuna:</label>
          <input type="search" name="busqueda2" id="busqueda2" class="ingreso_datos"
            required>
